...
export const studentRouterMap = [

    {
        ...
        hidden:false,
        children: [
            {path: '/News',name: '竞赛新闻',icon:'speedometer',component: _import('student/News')},
            {path: '/components',name: 'component组件',redirect: '/components/buttons',icon:'bookmark',
                component: {render (c) { return c('router-view') }},
                children: [ {path: 'buttons',name: 'Buttons按钮',icon:'social-youtube',component: _import('components/Buttons'), hidden:false, },
                    {path: 'hoverbuttons',name: '悬停特效按钮',icon:'wand',component: _import('components/HoverButtons')},
...

    {
        ...
        children: [
            {path: '/teacher',name: '新闻',redirect: '/teacher/News',icon:'pie-graph',
                component: {render (c) { return c('router-view') }},
                children: [ {path: 'News',name: '老师竞赛新闻',icon:'stats-bars',component: _import('teacher/News'), hidden:false, },
                    {path: 'NewsInfo',name: '老师竞赛新闻详情',icon:'arrow-graph-up-right',component: _import('teacher/NewsInfo'),hidden:true},
                ]
            },
            {path: '/components',name: 'component组件',redirect: '/components/buttons',icon:'bookmark',
                component: {render (c) { return c('router-view') }},
