          ...
          >
              ...
              <el-table-column
                  ...
                  <template  slot-scope="scope">
                      <p v-if="scope.row.matchStatus == '0'"> 000</p>
                      <p v-if="scope.row.matchStatus == '1'"> 111</p>
                      <p v-if="scope.row.matchStatus == '2'"> 222</p>
                      <p v-if="scope.row.matchStatus == '3'"> 333</p>
                  </template>
              </el-table-column>
              ...
              <el-table-column label="详情"  align="center">
                  ...
                  <template v-if="scope.row.teacherName == null" slot-scope="scope">
                      ...
                      <el-button type="primary"  size="small" @click="showCheck(scope.row.id,scope.row.title)">查看详情</el-button>
                  </template>
              </el-table-column>
