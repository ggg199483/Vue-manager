    ...
    export default {
        ...
        data() {
            ...
            const validatePass = (rule, value, callback) => {
                if (value === '') {
                    ...
                    callback(new Error('长度要在 6 到 10 个字符'));
                }
                else {
            ...
            return {
                ...
                rules: {
                    ...
                    pass: [
                        { validator: validatePass, message: '长度在 6 到 10个字符',trigger: 'blur' }
                    ],
                    checkPass: [
        ...
        methods: {
            getUserInfo(val){
                ...
                fetch({
                    url: '/hello/change-userLoginInfo',
                    method: 'post',
                    params: data
                }).then(response => {
            ...
            submitForm(formName) {
                this.getUserInfo(this.$store.getters.token);
            },
            resetForm(formName) {
